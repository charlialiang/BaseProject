...
public class ItemView extends RelativeLayout {
    ...
    public ItemView(Context context, AttributeSet attrs) {
        ...
        int tv1Color = tArray.getResourceId(R.styleable.ItemView_text1Color, R.color.colorText);
        int tv2Color = tArray.getResourceId(R.styleable.ItemView_text2Color, R.color.colorText);
