...
public class HandlerUtils {
    ...
    public static void sendMessage(Handler handler, int what, long delayMillis) {
        removeHandlerMsg(handler, what);
        handler.sendEmptyMessageDelayed(what, delayMillis);
    }

    public static void sendMessage(Handler handler, int what, Object obj, long delayMillis) {
        removeHandlerMsg(handler, what);
        handler.sendMessageDelayed(handler.obtainMessage(what, obj), delayMillis);
    }

    public static void sendMessage(Handler handler, Message message, long delayMillis) {
        removeHandlerMsg(handler, message.what);
